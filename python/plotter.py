...
plt.xlabel('Threads')
plt.ylabel('Time(ms)')
plt.annotate('Min C: %d, %.1f'%(xmin1, ymin1), (xmin1, ymin1), xytext=(xmin1, ymin1 + 1000), bbox=bbox, arrowprops=arrowprops)
plt.annotate('Min Rust: %d, %.1f'%(xmin2, ymin2), (xmin2, ymin2), xytext=(xmin2, ymin2 + 500), bbox=bbox, arrowprops=arrowprops)
plt.show()
